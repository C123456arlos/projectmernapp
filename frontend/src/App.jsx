  ...
  <Navbar></Navbar>
      <Routes>
        ...
        <Route path='/category/:category' element={<CategoryPage></CategoryPage> }></Route>
          <Route path='/cart' element={user ? <CartPage></CartPage> : <Navigate to='/login'></Navigate>}></Route>
          <Route path='/purchase-success' element={user ?<PurchaseSuccessPage></PurchaseSuccessPage>:<Navigate to='/login'></Navigate>}></Route>
          <Route path='/purchase-cancel' element={user ?<PurchaseCancelPage></PurchaseCancelPage>:<Navigate to='/login'></Navigate>}></Route>
        </Routes>
      </div>
      <Toaster></Toaster>
    </div>
